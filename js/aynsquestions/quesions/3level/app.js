...
// function sendingAddress(addresss, cb) {
//     cb(`ur active will be placed at your ${addresss} `)
// }
...
//                             // console.log(valid);
//                             sendingAddress("anand", function (address) {
//                                 console.log(address);
//                             })
//                         })
//                     })
...
function loginUser(username, cb) {
    ...
    setTimeout(() => {
        cb({ id: 1212, name: "harsh" })
    }, 1000);
}
function fetchpermisssion(data, cb) {
    console.log("fethcing ur info...")
    setTimeout(() => {
        cb(["read", "write", "delete"])
    }, 2000);
}
function loadDashboard() {
    console.log("permisssionsss...")
    setTimeout(() => {
        cb();
    }, 3000);
}
...
loginUser("harsh", function (data) {
    fetchpermisssion(data.id, function (permission) {
        loadDashboard(permission, function (load) {
